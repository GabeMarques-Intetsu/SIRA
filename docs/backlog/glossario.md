...
> **Adapte**: extraia os termos das entidades/modelos reais do domínio do projeto.

## A

- **<Termo>** — <definição curta; cite a ADR que o fixou se houver>.

<!-- mantenha em ordem alfabética; um termo por linha -->
